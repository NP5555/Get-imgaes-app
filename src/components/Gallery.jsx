...
const Gallery = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-black bg-opacity-30">

      <div className="container mx-auto px-4 py-8 bg-gradient-to-r from-gray-900 via-gray-800 to-black">
